...
public class HomeController : Controller
{
    ...
    public IActionResult Storefront()
    {
        List<Product> AllProducts = _context.Products
            // .Include(p => p.TagsOfProduct) // Include the TagsOfProduct navigation property
                // .ThenInclude(tp => tp.TagInCorrelation) // Include the TagInCorrelation navigation property within TagsOfProduct
            .ToList();
